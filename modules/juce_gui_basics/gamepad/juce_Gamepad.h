...
public:
    ...
    */
    ...
    /** @returns the type of gamepad.
        This will return 'none' if disconnected.
        If there's a possible controller present but it's not in
        the pre-identified list, this will return 'unknown'.
    */
    Type getType() const;
    ...
    */
    ...
    /** @returns the subtype of gamepad.
        This will return 'none' if disconnected.
        If there's a possible controller present but it's not in
        the pre-identified list, this will return 'unknown'.
    */
    ...
    */
    ...
    /** A list of possible action buttons that a controller may have.
        ...
        On Microsoft Xbox and Luna controllers, the button layout looks this:
          Y
         / \
        X   B
         \ /
        ...
        On Nintendo Switch controllers, the button layout looks this:
          X
         / \
        Y   A
         \ /
        ...
        On Sony PlayStation controllers, the button layout looks this:
           ^
          / \
        []   O
          \ /
    ...
    */
    ...
    /** Some controllers may support ranges for some or all of their shoulder buttons.
        ...
        For the buttons that don't have this option,
        this will simply return a 0 (is up/unpressed) or 1 (is down/pressed).
