...
namespace KeyPressHelpers
{
    ...
    const KeyNameAndCode translations[] =
    {
        ...
        { "caps lock",      KeyPress::capsLockKey },
        { "num lock",       KeyPress::numLockKey },
        { "scroll lock",    KeyPress::scrollLockKey },
        { "pause",          KeyPress::pauseKey },
        { "print screen",   KeyPress::printScreenKey },
        { "menu",           KeyPress::menuKey },
        { "left shift",     KeyPress::leftShiftKey },
        { "right shift",    KeyPress::rightShiftKey },
        { "left ctrl",      KeyPress::leftCtrlKey },
        { "right ctrl",     KeyPress::rightCtrlKey },
        { "left alt",       KeyPress::leftAltKey },
        { "right alt",      KeyPress::rightAltKey },
        { "left windows",   KeyPress::leftWindowsKey },
        { "right windows",  KeyPress::rightWindowsKey },
        { "play pause",     KeyPress::playPauseKey },
        ...
        { "mail",           KeyPress::mailKey },
        { "calculator",     KeyPress::calculatorKey },
        { "my computer",    KeyPress::myComputerKey },
        { "sleep",          KeyPress::sleepKey },
        { "wake up",        KeyPress::wakeUpKey },
        { "channel up",     KeyPress::channelUpKey },
        { "channel down",   KeyPress::channelDownKey },
        { "guide",          KeyPress::guideKey },
        { "info",           KeyPress::infoKey },
        { "exit",           KeyPress::exitKey },
        { "red",            KeyPress::redKey },
        { "green",          KeyPress::greenKey },
        { "yellow",         KeyPress::yellowKey },
        { "blue",           KeyPress::blueKey },
        { "live tv",        KeyPress::liveTvKey },
        { "recorded tv",    KeyPress::recordedTvKey },
        { "replay",         KeyPress::replayKey },
        { "skip forward",   KeyPress::skipForwardKey },
        { "aspect ratio",   KeyPress::aspectRatioKey },
        { "subtitle",       KeyPress::subtitleKey },
        { "audio language", KeyPress::audioLanguageKey },
        { "zoom",           KeyPress::zoomKey },
        { "power",          KeyPress::powerKey }
    };
