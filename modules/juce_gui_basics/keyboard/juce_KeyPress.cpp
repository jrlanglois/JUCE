...
namespace KeyPressHelpers
{
    ...
    const KeyNameAndCode translations[] =
    {
        ...
        { "captions",       KeyPress::captionsKey },
        { "settings",       KeyPress::settingsKey },
        { "find",           KeyPress::findKey },
        { "help",           KeyPress::helpKey },
        { "red",            KeyPress::buttonRed },
        { "green",          KeyPress::buttonGreen },
        { "blue",           KeyPress::buttonBlue },
        { "yellow",         KeyPress::buttonYellow },
        { "start",          KeyPress::startKey },
        { "select",         KeyPress::selectKey },
        { "button A",       KeyPress::buttonAKey },
        { "button B",       KeyPress::buttonBKey },
        { "button C",       KeyPress::buttonCKey },
        { "button X",       KeyPress::buttonXKey },
        { "button Y",       KeyPress::buttonYKey },
        { "button Z",       KeyPress::buttonZKey },
        { "button L1",      KeyPress::buttonL1Key },
        { "button L2",      KeyPress::buttonL2Key },
        { "button R1",      KeyPress::buttonR1Key },
        { "button R2",      KeyPress::buttonR2Key }
    };
